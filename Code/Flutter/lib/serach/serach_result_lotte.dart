...
class SearchResultLotte extends StatelessWidget {
  String correction;

  SearchResultLotte({super.key, required this.correction});
              ...
              children: [
                ...
                state is PostAntiqueLoadingState
                    ...
                    : ListView.builder(
                        ...
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount:
                            cubit.modelSearchLotte.documents?.first.length ?? 0,
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  if (cubit.modelSearchLotte.distances!
                                          .first[index] <
                                      0.7) ...{
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            'distances : ${cubit.modelSearchLotte.distances!.first[index]}',
                                            style: const TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: ExpandableText(
                                      text: cubit.modelSearchLotte.documents!
                                          .first[index],
